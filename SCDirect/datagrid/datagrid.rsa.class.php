...
##  PHP DataGrid Advanced version 5.0.8 (04.08.2009)                           #
...
##  -- PEAR::DB v1.7.11 (PHP Ext.&Application Repository)  http://pear.php.net #

##  -- JS AFV v1.0.6 (JS Auto From Validator)                 http://apphp.com #
...
##  *** "default", "blue", "gray", "green" or "pink" or "empty" your own css file 
...
//             use it after DataSource() method only (using this method before bind() requires redefenition of DataSource())
...

{
    ...
    function __construct($debug_mode = false, $messaging = true, $unique_prefix = "", $datagrid_dir = "datagrid/"){
        ...
        if(eregi("print=true", $_SERVER['QUERY_STRING'])) $this->isPrinting = true;
        ...
        $this->scrollingWidth = "90%";

        $this->scrollingHeight = "100%";
    ...
    function setScrollingSettings($width="", $height=""){
        ...
        if($width != "") $this->scrollingWidth = $width;
    ...
    function AllowSorting   ($option = true) { $this->sortingAllowed   = (($option == true) || ($option == "true")) ? true : false ; }    
    ...
    function SetPagingSettings($lower=false, $upper=false, $pages_array=false, $default_page_size="", $paging_arrows=""){
        ...
        if(is_array($lower) && (count($lower) > 0)){
        ...
        if(is_array($filter_fields_array)){
            ...
            if($req_onSUBMIT_FILTER != ""){
                ...
                foreach($filter_fields_array as $fldName => $fldValue){
                    ...
                    $field_property_filter_condition  = $this->GetFieldProperty($fldName, "filter_condition", "filter", "normal");
                    ...
                    foreach($fldValue_fields as $fldValue_field){
                        ...
                        if(isset($_REQUEST[$field_name_in_url]) && ($_REQUEST[$field_name_in_url] !== "")){                        
                            ...
                            if(!is_array($fldTableFieldName)) $split_fldTableFieldName = split(",",$fldTableFieldName);
                            ...
                            if($field_property_filter_condition != ""){

                                $this->sqlView .= (eregi("and", $field_property_filter_condition)) ? " ".$field_property_filter_condition." " : " AND ".$field_property_filter_condition." ";
    ...
    function Bind($show = true){                               
        ...
        if($this->ajaxEnabled){
            ...
            if($this->ajaxEnabled) echo "<div id='".$this->uniquePrefix."ajax_loading_image' style='position:absolute;display:none;margin-left:auto;margin-right:auto;left:50%;right:50%;top:15px;width:28px;height:28px;'><img src='".$this->directory."images/ajax_loading.gif' alt='".$this->lang['loading_data']."' border='0' /></div>\n";
        ...
        if($this->dbHandler){       
            ...
            if($sql != ""){
                ...
                if($this->debug){
                    ...
                    $this->sqlStatements[] = "<table width='".$this->tblWidth[$this->mode]."'><tr><td align='left'><label class='".$this->cssClass."_dg_label'><b>select sql (".Helper::ConvertCase($this->lang['total'],"lower",$this->langName).": ".$num_cols.") </b>".$sql."</label></td></tr>".$debugInfo."</table>";
    ...
    protected function TblOpen($style=""){
        ...
        echo "<table dir='".$this->direction."' class='".$this->cssClass."_dg_table' style='".$horizontal_align."' width='".$width."' ".$style.">".chr(13);
    ...
    protected function ScrollDivOpen(){
        ...
        if($this->scrollingOption == true){
            ...
            echo "<center><div style='TEXT-ALIGN:center; PADDING:0px; WIDTH:".$this->scrollingWidth."; HEIGHT:".$this->scrollingHeight."; overflow:auto;'>";
    ...
    protected function DrawControlPanel(){       
        ...
        if($this->filteringAllowed || $this->exportingAllowed || $this->printingAllowed){
            ...
            $use_question_sign = ($_SERVER['QUERY_STRING'] == "") ? true : false;            

            if($this->exportingAllowed){                

                if($this->ajaxEnabled){

                    $export_location = "'".(($use_question_sign) ? "?" : $this->HTTP_URL."?".$_SERVER['QUERY_STRING']."&").$this->uniquePrefix."export=true'";   
                ...
                if((($req_export == "") || ($this->isPrinting != true)) && ($this->isPrinting == "")){                    

                    if($this->arrExportingTypes["excel"] == true){

                        echo "<td align='right' style='width: 20px;'>";

                        echo "<a style='cursor:pointer;' onClick=\"".$myRef_window."=window.open(".$export_location."+'&amp;".$this->uniquePrefix."export_type=csv','ExportToExcel','left=100,top=100,width=540,height=360,toolbar=0,resizable=0,location=0,scrollbars=1');".$myRef_window.".focus();\" class='".$this->cssClass."_dg_a'>";

                        echo "<img src='".$this->directory."styles/".$this->cssClass."/images/excel_b.gif'  onmouseover='this.src=\"".$this->directory."styles/".$this->cssClass."/images/excel_r.gif\"' onmouseout='this.src=\"".$this->directory."styles/".$this->cssClass."/images/excel_b.gif\"' alt='".$this->lang['export_to_excel']."' title='".$this->lang['export_to_excel']."' /></a>";
                    ...
                    if($this->arrExportingTypes["pdf"] == true){
                        ...
                        echo "<img src='".$this->directory."styles/".$this->cssClass."/images/pdf.jpg'  onmouseover='this.src=\"".$this->directory."styles/".$this->cssClass."/images/pdf.jpg\"' onmouseout='this.src=\"".$this->directory."styles/".$this->cssClass."/images/pdf.jpg\"' alt='".$this->lang['export_to_pdf']."' title='".$this->lang['export_to_pdf']."' /></a>";
                    ...
                    if($this->arrExportingTypes["xml"] == true){
                        ...
                        echo "<img src='".$this->directory."styles/".$this->cssClass."/images/xml_b.png'  onmouseover='this.src=\"".$this->directory."styles/".$this->cssClass."/images/xml_r.png\"' onmouseout='this.src=\"".$this->directory."styles/".$this->cssClass."/images/xml_b.png\"' alt='".$this->lang['export_to_xml']."' title='".$this->lang['export_to_xml']."' /></a>";
            ...
            if($this->printingAllowed){
                ...
                if($this->ajaxEnabled){
                    ...
                    $print_location = "'".(($use_question_sign) ? "?" : $this->HTTP_URL."?".$_SERVER['QUERY_STRING']."&").$this->uniquePrefix."print=true'";   
                ...
                if(($req_export == "") && ($this->isPrinting != true)){

                    echo "<td align='right' style='width: 20px;'><a style='cursor:pointer;' onClick=\"".$myRef_window."=window.open(".$print_location.",'PrintableView','left=20,top=20,width=840,height=630,toolbar=0,menubar=0,resizable=0,location=0,scrollbars=1');".$myRef_window.".focus()\" class='".$this->cssClass."_dg_a'><img src='".$this->directory."styles/".$this->cssClass."/images/print_b.gif' onmouseover='this.src=\"".$this->directory."styles/".$this->cssClass."/images/print_r.gif\"' onmouseout='this.src=\"".$this->directory."styles/".$this->cssClass."/images/print_b.gif\"' alt='".$this->lang['printable_view']."' title='".$this->lang['printable_view']."' /></a></td>";
            ...
            if($this->filteringAllowed && ($this->mode == "view") && ($req_mode != "update") && ($req_mode != "delete")){
                ...
                if($this->isPrinting != true){
                    ...
                    $href_string = ($this->ajaxEnabled) ? "javascript:".$this->uniquePrefix."_doAjaxRequest(\"".(($_SERVER['QUERY_STRING']!="") ? "?".$_SERVER['QUERY_STRING'] : "")."\");" : "document.location.href=self.location;";

                    echo "<td align='right' style='width: 20px;'><a style='cursor:pointer;' onClick='".$href_string."' class='".$this->cssClass."_dg_a'><img src='".$this->directory."styles/".$this->cssClass."/images/recycle.gif' alt='".$this->lang['refresh_page']."' title='".$this->lang['refresh_page']."' /></a></td>";
    ...
    protected function DrawFiltering(){
        ...
        if($this->filteringAllowed){
            ...
            echo "<table id='".$this->uniquePrefix."searchset' style='".$horizontal_align." ".$this->hideDisplay."' width='".(($this->browserName == "Firefox") ? "99%" : "100%" )."'><tr><td style='text-align: center;'>\n";
            ...
            echo "<table class='".$this->cssClass."_dg_filter_table' border='0' id='filterTbl".$this->uniquePrefix."' style='margin-left: auto; margin-right: auto;' width='".$this->tblWidth[$this->mode]."' cellspacing='1' cellpadding='1'>\n<tbody>\n";
            ...
            foreach($this->arrFilterFields as $fldName => $fldValue){
                ...
                if($this->layouts['filter'] == "1"){
                    ...
                    if($this->tabularColumns != ""){
                        ...
                        echo ($this->direction == "rtl")?"right":"left";
                ...
                if(isset($fldValue['show_operator']) && $fldValue['show_operator'] != false && $fldValue['show_operator'] != "false"){
                    ...
                    if($this->isPrinting != true){
                        ...
                        echo "<option value='".urlencode("like%")."'"; echo (urldecode($filter_operator) == "like%")? " selected" : ""; echo ">".$this->lang['like%']."</option>";
                ...
                if($this->isPrinting != true){
                    ...
                    switch($filter_field_type){
                        ...
                        case "textbox":
                            ...
                            foreach($fldValue_fields as $fldValue_field){
                                ...
                                if($count++ == 0){
                                    ...
                                    echo "\n<input class='".$this->cssClass."_dg_textbox' style='".$field_width."' type='text' value='".$filter_field_value_html."' name='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field."' id='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field."' onchange='".$onchange_filter_field."this.value;' ".$field_property_on_js_event.">";
                                    ...
                                    echo "\n<input type='hidden' name='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field."' id='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field."' value='".$filter_field_value_html."'>";                                    
                        ...
                        case "dropdownlist":
                            ...
                            echo "<select class='".$this->cssClass."_dg_select' style='".$field_width."' name='".$field_ddl_name."' id='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue['field']."' ".$field_property_on_js_event." ".$multiple_parameters.">";
                            ...
                            if(is_array($fldValue['source'])){
                                ...
                                $field_property_field_view = $this->GetFieldProperty($fldName, "field_view", "filter", "normal");                                

                                if($field_property_field_view !== ""){                                    

                                    $sql = "SELECT DISTINCT ".$fldValue['field'].", ".$field_property_field_view." FROM ".$fldValue['table']." WHERE ".$where." ORDER BY ".$fldValue['field']." ".((Helper::ConvertCase((isset($fldValue['order']) ? $fldValue['order'] : ""),"lower",$this->langName) == "desc")?"DESC":"ASC")." ";
                                    ...
                                    if($this->dbHandler->isError($dSet) == 1){
                                        ...
                                        while($row = $dSet->fetchRow()){
                                            ...
                                            $ff_name = $field_property_field_view;
                        ...
                        case "calendar":
                            ...
                            foreach($fldValue_fields as $fldValue_field){
                                ...
                                if($count++ == 0){
                                    ...
                                    echo "\n<input class='".$this->cssClass."_dg_textbox' style='".$field_width."' type='text' value='".$filter_field_value."' name='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field.$field_property_field_type."' id='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field.$field_property_field_type."' onchange='".$onchange_filter_field."this.value;' ".$field_property_on_js_event.">";

                                }else{

                                    $filter_field_operator = $table_field_name."_".$fldValue_field."_operator";

                                    echo "\n<input type='hidden' name='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field."' id='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field."' value='".$filter_field_value."'>";                                    
                            ...
                            if($field_property_calendar_type == "floating"){                                
                                ...
                                $textbox_id = $this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field.$field_property_field_type;                                

                                echo "<img id='img_".$textbox_id."' src='".$this->directory."styles/".$this->cssClass."/images/cal.gif' alt='".$this->lang['set_date']."' title='".$this->lang['set_date']."' align='top' style='cursor:pointer;margin:3px;margin-left:6px;margin-right:6px;border:0px;'></a>".$this->nbsp.$this->ScriptOpen()."Calendar.setup({inputField : '".$textbox_id."', ifFormat : '".$if_format."', showsTime : ".$show_time.", button : 'img_".$textbox_id."'});".$this->ScriptClose();

                            }else{

                                echo "<a class='".$this->cssClass."_dg_a2' title='' href=\"javascript:openCalendar('".(($this->ignoreBaseTag) ? $this->HTTP_HOST."/" : "").$this->directory."','', 'frmFiltering".$this->uniquePrefix."', '', '".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue_field.$field_property_field_type."', '".$date_format."')\"><img src='".$this->directory."styles/".$this->cssClass."/images/cal.gif' alt='".$this->lang['set_date']."' title='".$this->lang['set_date']."' align='top' style='border:0px; MARGIN:3px;margin-left:6px;margin-right:6px;'></a>".$this->nbsp;
                        ...
                        default:
                            ...
                            echo "\n<input class='".$this->cssClass."_dg_textbox' type='text' value='".$filter_field_value_html."' name='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue['field']."' id='".$this->uniquePrefix."_ff_".$table_field_name."_".$fldValue['field']."'>";                                        
                ...
                else if($this->layouts['filter'] == "0" && $this->tabularColumns != "" && $this->tabularColumns > 0){
            ...
            if($this->isPrinting != true){
                ...
                if($req_onSUBMIT_FILTER != ""){
                    ...
                    echo "<input class='".$this->cssClass."_dg_button' type='button' value='".$this->lang['reset']."' onClick='document.location.href=\"".((!$this->ignoreBaseTag) ? $this->HTTP_URL : "").$curr_url."\"' />&nbsp;";

                }

                echo "<input class='".$this->cssClass."_dg_button' type='submit' name='".$this->uniquePrefix."_ff_"."onSUBMIT_FILTER' id='".$this->uniquePrefix."_ff_"."onSUBMIT_FILTER' value='".$this->lang['search']."' />";
    ...
    protected function DrawCustomized(){
        ...
        if($req_mode == "add"){
            ...
            for($r = $this->rowLower; (($r >=0 && $this->rowUpper >=0) && ($r < $this->rowUpper) && ($r < ($this->rowLower + $this->reqPageSize))); $r++){
                ...
                $mode_button = $this->DrawModeButton("add", "javascript:".$this->uniquePrefix."_doPostBack(\"add\", \"-1\");", $this->lang['add_new'], $this->lang['add_new_record'], "add.gif", "''", false, "", "", true);                        
                ...
                $mode_button = $this->DrawModeButton("edit", "javascript:".$this->uniquePrefix."_doPostBack(\"edit\", ".$row[$ind].");", $this->lang['edit'], $this->lang['edit_record'], "edit.gif", "''", false, $this->nbsp, "", true);
                ...
                $mode_button = $this->DrawModeButton("details", "javascript:".$this->uniquePrefix."_doPostBack(\"details\", ".$row[$ind].");", $this->lang['details'], $this->lang['view_details'], "details.gif", "''", false, $this->nbsp, "", true);                        
                ...
                $mode_button = $this->DrawModeButton("cancel", "javascript:".$this->uniquePrefix."_doPostBack(\"cancel\", ".$row[$this->GetFieldOffset($this->primaryKey)].");", $this->lang['back'], $this->lang['back'], "cancel.gif", "''", false, $this->nbsp, "", true);
    ...
    protected function DrawTabular(){
        ...
        if(isset($this->modes['add'][$this->mode]) && $this->modes['add'][$this->mode] &&
           ...
           isset($this->modes['add']['show_add_button']) && ($this->modes['add']['show_add_button'] == "outside")){
            ...
            $this->DrawModeButton("add", "javascript:".$this->uniquePrefix."_doPostBack(\"add\", \"-1\");", $this->lang['add_new'], $this->lang['add_new_record'], "add.gif", "''", false, "", "");                        
        ...
        $this->RowOpen("");
                ...
                if($this->mode === "view"){                
                    ...
                    for($c_sorted = $this->colLower; $c_sorted < count($this->sortedColumns); $c_sorted++){
                        ...
                        if($this->CanViewField($field_name)){
                            ...
                            if($this->sortingAllowed && ($this->isPrinting != true) && $req_sort_field && ($c == ($req_sort_field -1))){ $th_css_class = $this->cssClass."_dg_th_selected"; } else { $th_css_class = $this->cssClass."_dg_th" ;};                

                            $this->MainColOpen("center", 0, $field_property_wrap, $field_property_width, $th_css_class);

                            if($this->sortingAllowed && $field_property_sortable !== false){
                                ...
                                if($this->isPrinting != true){                                   
                                    ...
                                    echo "<b><a class='".$this->cssClass."_dg_a_header' href='".$href_string."' title='".$field_property_header_tooltip."' ";
            ...
            if(isset($this->modes['details'][$this->mode]) && $this->modes['details'][$this->mode] && $this->controlsDisplayingType == ""){
                ...
                $this->MainColOpen("center",0,"nowrap", "9%", $this->cssClass."_dg_th_normal");echo $this->lang['view'];$this->MainColClose();

            }                        

            if(isset($this->modes['delete'][$this->mode]) && $this->modes['delete'][$this->mode] && $this->controlsDisplayingType == ""){

                $this->MainColOpen("center",0,"nowrap", "9%", $this->cssClass."_dg_th_normal");echo $this->lang['delete'];$this->MainColClose();
        ...
        for($r = $this->rowLower; (($r >=0 && $this->rowUpper >=0) && ($r < $this->rowUpper) && ($r < ($this->rowLower + $this->reqPageSize))); $r++){            
            ...
            if($this->isMultirowAllowed){
                ...
                echo ($row[$this->GetFieldOffset($this->primaryKey)] != -1) ? $row[$this->GetFieldOffset($this->primaryKey)] : "0" ;
            ...
            if(isset($this->modes['edit'][$this->mode]) && $this->modes['edit'][$this->mode]){
                ...
                if(($this->mode == "edit") && $this->GetFieldOffset($this->primaryKey) != "-1" && (intval($this->rid) == intval($row[$this->GetFieldOffset($this->primaryKey)]))){
                    ...
                    $curr_url = $this->CombineUrl("update", $row[$this->GetFieldOffset($this->primaryKey)], $this->amp);
                    ...
                    $this->DrawModeButton("cancel", "javascript:".$this->uniquePrefix."_doPostBack(\"cancel\", ".$row[$this->GetFieldOffset($this->primaryKey)].");", $this->lang['cancel'], $this->lang['cancel'], "cancel.gif", "''", false, $this->nbsp, "");
                        ...
                        if (isset($this->modes['edit']['byFieldValue']) && ($this->modes['edit']['byFieldValue'] != "")){
                            ...
                            if($this->GetFieldOffset($this->modes['edit']['byFieldValue']) == "-1"){
                                ...
                                if($this->debug){
                                    ...
                                    $this->DrawModeButton("edit", "javascript:".$this->uniquePrefix."_doPostBack(\"edit\", ".$row_id.");", $this->lang['edit'], $this->lang['edit_record'], "edit.gif", "''", false, $this->nbsp, "");                                    
            ...
            for($c_sorted = $this->colLower; $c_sorted < count($this->sortedColumns); $c_sorted++){
                ...
                if(($this->mode === "view") && ($this->CanViewField($c_field_name))){                    
                    ...
                    if($req_sort_field == $c+1){
                        ...
                        $this->ColOpen($col_align, 0, $field_property_wrap, (($r % 2 == 0) ? $this->rowColor[8] : $this->rowColor[9]), $this->cssClass."_dg_td_selected"); 
                    ...
                    if(($field_property_summarize == "true") || ($field_property_summarize === true)){                        
                        ...
                        if($curr_value != "" && $curr_value != "0") $this->arrSummarizeColumns[$c_field_name]["count"]++;
    ...
    protected function DrawColumnar(){
        ...
        if(isset($this->modes['add'][$this->mode]) && $this->modes['add'][$this->mode]){
            ...
            $this->RowOpen($r, $this->rowColor[0]);            
                ...
                $this->DrawModeButton("add", "javascript:".$this->uniquePrefix."_doPostBack(\"add\", \"-1\");", $this->lang['add_new'], $this->lang['add_new'], "add.gif", "''", true, "", "");                        
        ...
        if($this->isLoadingImageEnabled && !$this->ajaxEnabled) echo "<div id='".$this->uniqueRandomPrefix."loading_image'><br><table align='center'><tr><td valign='middle'>".$this->lang['loading_data']."</td><td valign='middle'><img src='".$this->directory."images/loading.gif'></td></tr></table></div>\n";                
        ...
        $this->MainColOpen("center",0,"nowrap","32%", (($this->isPrinting == true) ? $this->cssClass."_dg_td" : $this->cssClass."_dg_th")); echo "<b>".(($this->fieldHeader != "") ? $this->fieldHeader : $this->lang['field'])."</b>"; $this->MainColClose(); 

        $this->MainColOpen("center",0,"nowrap","68%", (($this->isPrinting == true) ? $this->cssClass."_dg_td" : $this->cssClass."_dg_th")); echo "<b>".(($this->fieldHeaderValue != "") ? $this->fieldHeaderValue : $this->lang['field_value'])."</b>"; $this->MainColClose(); 
        ...
        if($this->rid == -1){            
            ...
            foreach($this->columnsEditMode as $key => $val){
                ...
                if(ereg("delimiter", $key)){
                    ...
                    $this->ColOpen('', 2, '', '', 'none', '', "style='padding:0px;margin:0px;'");
                ...
                if($this->CanViewField($c_field_name)){
                    ...
                    if($this->GetFieldProperty($c_field_name, "type") == "hidden"){                        
                        ...
                        if(($this->mode === "view") && ($this->CanViewField($c_field_name))){
                            ...
                            $this->ColOpen(($this->direction == "rtl")?"right":"left",0,"nowrap", "", "", "", "style='padding-top:5px;' valign='top'");
                    ...
                    if($this->mode != "details"){
                        ...
                        foreach($this->columnsEditMode as $key => $val){
                            ...
                            if($ind == $c_sorted){
                                ...
                                }else if(ereg("delimiter", $key)){ // customized rows (delimiter)                                
        ...
        if(($r == $this->rowLower) && ($this->rid != -1)){
            ...
            if($this->layoutType == "view" && $this->layouts['view'] == "1"){
                ...
                $this->MainColOpen('left', 0, '', '', (($this->isPrinting == true) ? $this->cssClass."_dg_td_normal" : $this->cssClass."_dg_th"), "style='BORDER-RIGHT: #d2d0bb 0px solid;'");
                ...
                if($this->mode === "details"){
                    ...
                    if($this->isPrinting != ""){
                        ...
                        $this->DrawModeButton("cancel", "javascript:".$this->uniquePrefix."_doPostBack(\"cancel\", ".$row[$this->GetFieldOffset($this->primaryKey)].");", $this->lang['back'], $this->lang['back'], "cancel.gif", "''", false, "", "");
                    ...
                    if(isset($this->modes['edit'][$this->mode]) && $this->modes['edit'][$this->mode]){
                        ...
                        if($req_mode === "add") {
                            ...
                            $this->DrawModeButton("cancel", "javascript:".$this->uniquePrefix."_doPostBack(\"cancel\", ".$rid.");", $this->lang['cancel'], $this->lang['cancel'], "cancel.gif", "''", false, $this->nbsp, "");
                        ...
                        if(isset($this->modes['cancel'][$this->mode]) && $this->modes['cancel'][$this->mode]){
                            ...
                            $this->DrawModeButton("cancel", "javascript:".$this->uniquePrefix."_doPostBack(\"cancel\", ".$row[$ind].");", $this->lang['back'], $this->lang['back'], "cancel.gif", "''", false, $this->nbsp, "");
                  ...
                  \n<tr>
                    ...
                    <td align='left' valign='middle' class='dg_nowrap'>";
                        ...
                        if($count > 0){
                            ...
                            echo "<img style='PADDING:0px; MARGIN:0px; border:0px;' src='".$this->directory."styles/".$this->cssClass."/images/arrow_ltr.png' width='38' height='22' alt='".$this->lang['with_selected'].":' title='".$this->lang['with_selected'].":'>";

                                if(!$this->isPrinting){

                                    echo "<a class='".$this->cssClass."_dg_a' href='javascript:void(0);' onClick='".$this->uniquePrefix."setCheckboxes(true); return false;'>".$this->lang['check_all']."</a>

                                    &nbsp;/&nbsp;

                                    <a class='".$this->cssClass."_dg_a' href='javascript:void(0);' onClick='".$this->uniquePrefix."setCheckboxes(false); return false;'>".$this->lang['uncheck_all']."</a>";

                                }else{

                                    echo "<a class='".$this->cssClass."_dg_label'>".$this->lang['check_all']."</label>

                                    &nbsp;/&nbsp;

                                    <a class='".$this->cssClass."_dg_label'>".$this->lang['uncheck_all']."</label>";                                    
                            ...
                            echo "    
                                ...
                                <label class='".$this->cssClass."_dg_label'><i>".$this->lang['with_selected'].":</i></label>&nbsp;&nbsp;
            ...
            for($c_sorted = $this->colLower; $c_sorted < count($this->sortedColumns); $c_sorted++){
                ...
                if($this->GetFieldProperty($c_field_name, "type") == "hidden"){
                    ...
                    if(($field_property_summarize == "true") || ($field_property_summarize === true)){
                        ...
                        }else if(strtolower($this->summarizeFunction) == "avg" && $this->arrSummarizeColumns[$c_field_name]["count"] != "0"){
    ...
    protected function PagingSecondPart($lu_paging=false, $upper_br, $lower_br, $type="1"){
        ...
        if($this->isPrinting != true) {$a_tag = "a";} else {$a_tag = "span";};
        ...
        if($this->pagesTotal >= 1){
            ...
            $text .= "\n<form name='frmPaging$this->uniquePrefix".$type."' id='frmPaging$this->uniquePrefix".$type."' action='' style='MARGIN:0px; PADDING:5px; '>";
            ...
            $text .= "<table class='".$this->cssClass."_dg_paging_table' dir='".$this->direction."' style='".$horizontal_align." width: ".$this->tblWidth[$this->mode].";' border='0' >";
    ...
    protected function IsDatePrepare($field_name, $fldValue, $mode = "edit", $attr = "type"){
        ...
        switch ($field_property_type){
            ...
            case 'datetimedmy': // date: DATETIME
                ...
                $time   = substr(trim($fldValue), 10, 9);
    ...
    protected function IsPasswordCrypted($field_name, $fldValue){
        ...
        if($field_property_type == "password" && ($field_property_cryptography == true || $field_property_cryptography == "true")){
            ...
            }else if($field_property_cryptography_type == "rsa"){

                return "RSA_ENCRYPT('".$fldValue."', '".$field_property_aes_password."')"; 
			}
        }
    ...
    protected function IsValidator($field_name){
        ...
        if($validator_letter == "v"){
            ...
            foreach($this->columnsEditMode as $key){
    ...
    protected function GetForeignKeyInput($keyFieldValue, $fk_field_name, $fk_field_value, $mode="edit"){
        ...
        if($mode === "edit"){            
            ...
            if($view_type == "label"){ //'view_type"=>"label"
                ...
                return "<input class='".$this->cssClass."_dg_textbox' type='text' title='".$this->GetFieldTitle($fk_field_name)."' id='".$this->GetFieldRequiredType($fk_field_name).$fk_field_name."' name='".$this->GetFieldRequiredType($fk_field_name).$fk_field_name."' value='".$kFieldValue."' $disabled ".$on_js_event.">";
                ...
                return $field_property_pre_addition.$this->DrawDropDownList($this->GetFieldRequiredType($fk_field_name).$fk_field_name, '', $dSet, $new_field_value, $fk_field_name, 'field_key', 'field_name', $disabled, $on_js_event).$field_property_post_addition;
    ...
    protected function CanViewField($field_name){
        ...
        if($this->mode === "view"){
            ...
            if(array_key_exists($field_name, $this->columnsViewMode) && ($field_property_visible == true)) return true;    

        }else if($this->mode === "edit"){

            if(array_key_exists($field_name, $this->columnsEditMode) && ($field_property_visible == true)) return true;    
    ...
    protected function GetHeaderName($field_name, $force_simple = false){
        ...
        if($this->mode === "view"){
            ...
            if(array_key_exists($field_name, $this->columnsViewMode) && ($field_property_header != "")){
            ...
            if(array_key_exists($field_name, $this->columnsEditMode) && ($field_property_header != "")){
    ...
    protected function GetFieldValueByType($field_value, $ind, $row, $field_name="", $m_field_req_type="", $mode=""){
        ...
        if($mode === "view"){
            ...
            if(array_key_exists($field_name, $this->columnsViewMode)){
                ...
                if($this->isPrinting == true){ $field_type = "label"; }                                                    
                ...
                switch($field_type){
                    ...
                    case "blob":
                        ...
                        return $field_property_pre_addition.$this->nbsp."[BLOB] - ".$sizeinbytes." B".$this->nbsp.$field_property_post_addition;
                    ...
                    case "enum":
                        ...
                        if (is_array($this->columnsViewMode[$field_name]["source"])){
                           ...
                           return $field_property_pre_addition.$this->nbsp.$this->columnsViewMode[$field_name]["source"][$field_value].$this->nbsp.$field_property_post_addition;
                    ...
                    case "image":
                        ...
                        if(($field_property_magnify == "true") || ($field_property_magnify === true)){
                            ...
                            if($field_property_magnify_type == "lightbox"){
                                ...
                                if((trim($field_value) !== "") && file_exists($img_src)){
                                    ...
                                    $ret_image = $this->nbsp."<img style='vertical-align: middle; border:0px solid #cccccc;cursor:pointer;' onClick=\"new_win=window.open('".$img_src."','ImageViewer','left=100,top=100,width=400,height=300,toolbar=0,menubar=0,resizable=1,location=0,scrollbars=1');new_win.focus()\" src='".$img_src."' width='".$field_property_image_width."' height='".$field_property_image_height."' ".$on_js_event." />".$this->nbsp;

                                }

                            }else if($field_property_magnify_type == "magnifier"){
                        ...
                        if ($field_property_linkto == "details" && $field_property_magnify != "true" && $field_property_magnify !== true){

                            $curr_url = $this->CombineUrl("details", intval($row[(($this->GetFieldOffset($this->primaryKey) != -1) ? $this->GetFieldOffset($this->primaryKey) : 0)]));
                    ...
                    case "label":
                        ...
                        if((trim($field_value) != "")
                            ...
                            return $field_property_pre_addition.$this->nbsp."<label class='".$this->cssClass."_dg_label' ".$title." ".$on_js_event.">".trim($field_value)."</label>".$this->nbsp.$field_property_post_addition;
                    ...
                    case "linkbutton":
                        ...
                        if($field_property_field_data != ""){
                            ...
                            if($this->GetFieldOffset($field_property_field_data) != "-1"){
                                ...
                                $field_value = trim($row[$this->GetFieldOffset($field_property_field_data)]);
                            ...
                            if($link_type == "1" || $link_type == "2"){
                                ...
                                if($field_type == "linkbutton"){
                                    ...
                                    return $field_property_pre_addition.$this->nbsp."<input type='button' class='".$this->cssClass."_dg_button' value='".$field_value."' onclick=\"javascript:document.location.href='".$href."'\">".$this->nbsp.$field_property_post_addition;

                                }else{                                    

                                    return $field_property_pre_addition.$this->nbsp."<a class='".$this->cssClass."_dg_a2' href=\"".$href."\" target='".$field_property_target."' ".$rel." title='".$title."' ".$on_js_event.">".$field_value."</a>".$this->nbsp.$field_property_post_addition;
                    ...
                    case "linktoview":
                        ...
                        $row_id = intval($row[(($this->GetFieldOffset($this->primaryKey) != -1) ? $this->GetFieldOffset($this->primaryKey) : 0)]);

                        return $field_property_pre_addition.$this->nbsp."<a class='".$this->cssClass."_dg_a' href='javascript:".$this->uniquePrefix."_doPostBack(\"details\", ".$row_id.");' ".$title." ".$on_js_event.">".trim($field_value)."</a>".$this->nbsp.$field_property_post_addition;
                    ...
                    case "linktoedit":
                        ...
                        return $field_property_pre_addition.$this->nbsp."<a class='".$this->cssClass."_dg_a' href='javascript:".$this->uniquePrefix."_doPostBack(\"edit\", ".$row_id.");' ".$title." ".$on_js_event.">".trim($field_value)."</a>".$this->nbsp.$field_property_post_addition;
                    ...
                    case "linktodelete":
                        ...
                        return $field_property_pre_addition.$this->nbsp."<a class='".$this->cssClass."_dg_a' href='javascript:".$this->uniquePrefix."verifyDelete(".$row_id.");' ".$title." ".$on_js_event.">".trim($field_value)."</a>".$this->nbsp.$field_property_post_addition;
                    ...
                    case "money": 
                        ...
                        if((trim($field_value) != "") 
                            ...
                            return $field_property_pre_addition.$this->nbsp."<label>".trim($money_sign_before.number_format($field_value, $field_property_decimal_places, $field_property_dec_separator, $field_property_thousands_separator)).$money_sign_after."</label>".$this->nbsp.$field_property_post_addition;
                    ...
                    case "password":                        
                        ...
                        return $field_property_pre_addition.$this->nbsp."<label class='".$this->cssClass."_dg_label' ".$title." ".$on_js_event.">".(($field_property_hide == "true" || $field_property_hide == true) ? "******" : $field_value)."</label>".$this->nbsp.$field_property_post_addition;

                        break;                    

                    default:

                        return $field_property_pre_addition.$this->nbsp."<label class='".$this->cssClass."_dg_label' ".$title." ".$on_js_event.">".trim($field_value)."</label>".$this->nbsp.$field_property_post_addition; break;
        ...
        // -= ADD / EDIT / DETAILS MODE =-    
            ...
            if(array_key_exists($field_name, $this->columnsEditMode)){
                ...
                $show_seconds                    = $this->GetFieldProperty($field_name, "show_seconds");

                $date_time_format                = ($show_seconds === false) ? "Y-m-d H:i" : "Y-m-d H:i:s";
                ...
                if($this->isPrinting == true){ $field_type = "print"; }
                ...
                if ($mode === "edit"){
                    ...
                    switch($field_type){
                        ...
                        case "blob":                           
                            ...
                            return $field_property_pre_addition.$this->nbsp."<textarea class='".$this->cssClass."_dg_textbox' name='".$field_req_type.$field_name."' id='".$field_req_type.$field_name."' title='".$this->GetFieldTitle($field_name)."' rows='3' cols='50' ".$readonly.">".$field_value."</textarea>".$this->nbsp.$field_property_post_addition;
                        ...
                        case "datetime":
                            ...
                            return $this->DrawCalendarButton($field_name, $field_type, $date_time_format, $field_value, $field_property_pre_addition, $field_property_post_addition, $field_width, $field_maxlength, $on_js_event, $readonly, $field_property_calendar_type);
                            ...
                            switch($field_property_view_type){
                                ...
                                case "radiobutton":
                                    ...
                                    if(is_array($this->columnsEditMode[$field_name]["source"])){  // don't remove columns_edit_mode
                                        ...
                                        $ret_enum .= $this->nbsp.$this->DrawRadioButtons($this->GetFieldRequiredType($field_name).$field_name, $field_name, $this->columnsEditMode[$field_name]["source"], $field_value, 'source', "", $disabled, $on_js_event, $field_property_radiobuttons_alignment).$this->nbsp;

                                    }else{

                                        $ret_enum .= $this->nbsp.$this->DrawRadioButtons($this->GetFieldRequiredType($field_name).$field_name, $field_name, $this->GetEnumValues($this->tblName, $field_name), $field_value, 'source', "", $disabled, $on_js_event, $field_property_radiobuttons_alignment).$this->nbsp;
                                ...
                                case "checkbox":
                                    ...
                                    if(is_array($this->columnsEditMode[$field_name]["source"])){  // don't remove columns_edit_mode
                                        ...
                                        $ret_enum .= $this->nbsp.$this->DrawCheckBoxes($this->GetFieldRequiredType($field_name).$field_name, '', $this->columnsEditMode[$field_name]["source"], $field_value, "", "", "", $disabled, $on_js_event, $enum_multiple, $field_property_multiple_size).$this->nbsp;

                                    }else{

                                        $ret_enum .= $this->nbsp.$this->DrawCheckBoxes($this->GetFieldRequiredType($field_name).$field_name, '', $this->GetEnumValues($this->tblName, $field_name), trim($field_value), "", "", "", $disabled, $on_js_event, $enum_multiple, $field_property_multiple_size).$this->nbsp;
                                ...
                                default:                                
                                    ...
                                    if(is_array($this->columnsEditMode[$field_name]["source"])){  // don't remove columns_edit_mode
                                        ...
                                        $ret_enum .= $this->nbsp.$this->DrawDropDownList($this->GetFieldRequiredType($field_name).$field_name, '', $this->columnsEditMode[$field_name]["source"], $field_value, "", "", "", $disabled, $on_js_event, $enum_multiple, $field_property_multiple_size).$this->nbsp;

                                    }else{

                                        $ret_enum .= $this->nbsp.$this->DrawDropDownList($this->GetFieldRequiredType($field_name).$field_name, '', $this->GetEnumValues($this->tblName, $field_name), trim($field_value), "", "", "", $disabled, $on_js_event, $enum_multiple, $field_property_multiple_size).$this->nbsp;
                            ...
                            if($this->GetFieldProperty($field_name, "host") == "remote"){
                                ...
                                if(trim($field_value) == ""){
                                    ...
                                    if(($file_act == "remove") && ($file_id == $field_name)){                                    
                                        ...
                                        if(!$this->isDemo){
                                            ...
                                            $sql = "UPDATE $this->tblName SET ".$field_name." = '' WHERE $this->primaryKey = '".$this->rid."' ";
                                            ...
                                            if($downloaded_file = fopen($field_value, "r")){
                                                ...
                                                if($uploaded_file = fopen($field_property_target_path.$field_value, "w")){
                                                    ...
                                                    if(!fwrite($uploaded_file, $content)){
                                                        ...
                                                        $sql = "UPDATE $this->tblName SET ".$field_name." = '".$field_value."' WHERE $this->primaryKey= '".$this->rid."'";
                                ...
                                if($file == true){
                                        ...
                                        if(($field_property_magnify == "true") || ($field_property_magnify == true)){
                                            ...
                                            if($field_property_magnify_type == "lightbox"){
                                                ...
                                                if((trim($field_value) !== "") && file_exists($img_src)){
                                                    ...
                                                    $ret_file_img = $this->nbsp."<a href='".$img_src."' rel='lytebox' title='$field_value ($f_width x $f_height - $f_size)'><img style='border:0px;' src='".$img_src."' height='".$field_property_image_height."' width='".$field_property_image_width."' title='$field_value ($f_width x $f_height - $f_size)' alt='$field_value' ".$img_magnify."></a>".$this->nbsp;
                                                ...
                                                if((trim($field_value) !== "") && file_exists($img_src)){
                                                    ...
                                                    $ret_image_img = $this->nbsp."<a href=\"javascript:new_win = window.open('".$img_src."','ImageViewer','left=100,top=100,width=400,height=300,toolbar=0,resizable=1,location=0,scrollbars=1'); new_win.focus();\" title=''><img style='vertical-align: middle; border:0px solid #cccccc;' src='".$img_src."' width='".$field_property_image_width."' height='".$field_property_image_height."' ".$on_js_event."></a>".$this->nbsp;
                                                ...
                                                if((trim($field_value) !== "") && file_exists($img_src)){
                                                    ...
                                                    $ret_file_img = $this->nbsp."<img src='".$img_src."' height='".$field_property_image_height."' width='".$field_property_image_width."' title='$field_value ($f_width x $f_height - $f_size)' alt='$field_value' ".$img_magnify.">".$this->nbsp;
                                    ...
                                    if(($field_property_readonly != "true") && ($field_property_readonly != true)){
                                        ...
                                        $ret_file .= $this->nbsp."[<a class='".$this->cssClass."_dg_a' href='' onclick='formAction(\"remove\", \"".$field_name."\", \"".$this->uniquePrefix."\", \"".$this->HTTP_URL."\", \"".$_SERVER['QUERY_STRING']."\"); return false;'><b>".$this->lang['remove']."</b></a>]".$this->nbsp;
                                    ...
                                    $ret_file .= $this->nbsp."<input type='textbox' class='".$this->cssClass."_dg_textbox' ".$field_width." title='".$this->GetFieldTitle($field_name)."' name='".$this->GetFieldRequiredType($field_name).$field_name."' id='".$this->GetFieldRequiredType($field_name).$field_name."' ".$disabled." ".$on_js_event.">&nbsp;&nbsp;";

                                    $ret_file .= "[<a class='".$this->cssClass."_dg_a' ".(($disabled == "disabled") ? "" : "style='cursor: pointer;' onclick='".$this->uniquePrefix."updateWysiwygFields(); formAction(\"upload\", \"".$field_name."\", \"".$this->uniquePrefix."\", \"".$this->HTTP_URL."\", \"".$_SERVER['QUERY_STRING']."\"); return false;'")."><b>".$this->lang['upload']."</b></a>]".$this->nbsp;                                
                                            ...
                                            if($file == true){
                                                ...
                                                if(isset($_FILES[$file_name]['tmp_name'])){
                                                    ...
                                                    if(move_uploaded_file($_FILES[$file_name]['tmp_name'], $target_path_full)) {                                                        
                                                        ...
                                                        $sql .= " WHERE $this->primaryKey= '".$this->rid."' ";
                                ...
                                if($file == true){
                                    ...
                                    if($field_type == "image"){
                                        ...
                                        if((trim($field_value) !== "") && file_exists($field_property_target_path.trim($field_value))){
                                            ...
                                            $ret_file_img = $this->nbsp."<img src='".$field_property_target_path.$field_value."' ".(($field_property_image_height != "") ? "height='".$field_property_image_height."'" : "")." ".(($field_property_image_width != "") ? "width='".$field_property_image_width."'" : "")." title='$field_value ($f_width x $f_height - $f_size)' alt='$field_value'>".$this->nbsp;
                                        ...
                                        if(($field_property_magnify == "true") || ($field_property_magnify == true)){
                                            ...
                                            if($field_property_magnify_type == "lightbox"){
                                                ...
                                                if((trim($field_value) !== "") && file_exists($img_src)){
                                                    ...
                                                    $ret_file_img = $this->nbsp."<a href='".$img_src."' rel='lytebox' title='$field_value ($f_width x $f_height - $f_size)'><img style='border:0px;' src='".$img_src."' ".(($field_property_image_height != "") ? "height='".$field_property_image_height."'" : "")." ".(($field_property_image_width != "") ? "width='".$field_property_image_width."'" : "")." title='$field_value ($f_width x $f_height - $f_size)' alt='$field_value' ".$img_magnify."></a>".$this->nbsp;
                                    ...
                                    if(($field_property_readonly != "true") && ($field_property_readonly != true)){
                                        ...
                                        $ret_file .= $this->nbsp."[<a class='".$this->cssClass."_dg_a' href='javascript:void(0);' onclick='formAction(\"remove\", \"".$field_name."\", \"".$this->uniquePrefix."\", \"".$this->HTTP_URL."\", \"".$_SERVER['QUERY_STRING']."\"); return false;'><b>".$this->lang['remove']."</b></a>]".$this->nbsp;
                                    ...
                                    $ret_file .= $this->nbsp."<input type='file' class='".$this->cssClass."_dg_textbox' ".$field_width." title='".$this->GetFieldTitle($field_name)."' name='".$this->GetFieldRequiredType($field_name).$field_name."' id='".$this->GetFieldRequiredType($field_name).$field_name."' ".$disabled." ".$on_js_event.">&nbsp;&nbsp;";
                        ...
                        case "label":
                            ...
                            return $field_property_pre_addition.$this->nbsp."<label class='".$this->cssClass."_dg_label' ".$field_width." ".$on_js_event.">".trim($field_value)."</label>".$this->nbsp.$field_property_post_addition; 

                            break;

                        case "link":

                            $test_link = " <a class='".$this->cssClass."_dg_a' style='cursor:pointer;' onclick=\"test_win = window.open(document.getElementById('".$this->GetFieldRequiredType($field_name).$field_name."').value,'testURL','');test_win.focus();\">[".$this->lang['test']."]</a>";

                            return $field_property_pre_addition.$this->nbsp."<input type='text' class='".$this->cssClass."_dg_textbox' ".$field_width." title='".$this->GetFieldTitle($field_name)."' name='".$this->GetFieldRequiredType($field_name).$field_name."' id='".$this->GetFieldRequiredType($field_name).$field_name."' value='".trim($field_value)."' $field_maxlength $readonly ".$on_js_event.">".$this->nbsp.$test_link.$field_property_post_addition;
                        ...
                        case "password":
                            ...
                            $ret_password = $this->nbsp."<input type='".(($field_property_hide == "true" || $field_property_hide == true) ? "password" : "text")."' class='".$this->cssClass."_dg_textbox' ".$field_width." title='".$this->GetFieldTitle($field_name)."' name='".$this->GetFieldRequiredType($field_name).$field_name."' id='".$this->GetFieldRequiredType($field_name).$field_name."' value='".$field_value."' $field_maxlength $readonly ".$on_js_event.">".$this->nbsp;
                        ...
                        case "print":
                            ...
                            return $field_property_pre_addition.$this->nbsp."<label class='".$this->cssClass."_dg_label' ".$field_width.">".trim($field_value)."</label>".$this->nbsp.$field_property_post_addition; 
                        ...
                        case "textbox":                           
                            ...
                            return $field_property_pre_addition.$this->nbsp."<input class='".$this->cssClass."_dg_textbox' ".$field_width." type='text' title='".$this->GetFieldTitle($field_name)."' name='".$field_req_type.$field_name."' id='".$field_req_type.$field_name."' value='".trim($field_value)."' ".$field_maxlength." ".$readonly." ".$on_js_event." ".$autocomplete.">".$this->nbsp.$field_property_post_addition;

                            break;

                        case "time":                            

                            $ret_date  = $this->nbsp."<input class='".$this->cssClass."_dg_textbox' ".$field_width." readonly type='text' title='".$this->GetFieldTitle($field_name)."' id='".$this->GetFieldRequiredType($field_name).$field_name."' name='".$this->GetFieldRequiredType($field_name).$field_name."' id='".$this->GetFieldRequiredType($field_name).$field_name."' value='".trim($field_value)."' $field_maxlength ".$on_js_event.">";

                            if($field_property_calendar_type == "floating"){

                                if(!$readonly) $ret_date .= "<img id='img".$this->GetFieldRequiredType($field_name).$field_name."' src='".$this->directory."styles/".$this->cssClass."/images/cal.gif' alt='".$this->lang['set_date']."' title='".$this->lang['set_date']."' align='top' style='cursor:pointer;margin:3px;margin-left:6px;margin-right:6px;border:0px;'></a>\n".$this->ScriptOpen()."Calendar.setup({inputField : '".$this->GetFieldRequiredType($field_name).$field_name."', ifFormat : '%H:%M:%S', showsTime : true, button : 'img".$this->GetFieldRequiredType($field_name).$field_name."'});".$this->ScriptClose().$this->nbsp;

                            }else{

                                if(!$readonly) $ret_date .= "<a class='".$this->cssClass."_dg_a2' title='".$this->GetFieldTitle($field_name)."' href=\"javascript:openCalendar('".(($this->ignoreBaseTag) ? $this->HTTP_HOST."/" : "").$this->directory."','', '".$this->uniquePrefix."frmEditRow', '$field_req_type', '".$field_name."', '$field_type')\"><img src='".$this->directory."styles/".$this->cssClass."/images/cal.gif' alt='".$this->lang['set_date']."' title='".$this->lang['set_date']."' align='top' style='MARGIN:3px;margin-left:6px;margin-right:6px;border:0px;'></a>".$this->nbsp;

                            }

                            if(!$readonly) $ret_date .= "<a class='".$this->cssClass."_dg_a2' style='cursor: pointer;' onClick='document.getElementById(\"".$this->GetFieldRequiredType($field_name).$field_name."\").value=\"".date("H:i:s")."\"'>[".date("H:i:s")."]</a>";

                            if((!$readonly) && (substr($this->GetFieldRequiredType($field_name), 0, 1) == "s")) $ret_date .= "&nbsp;<a class='".$this->cssClass."_dg_a2'  style='cursor: pointer;' onClick='document.getElementById(\"".$this->GetFieldRequiredType($field_name).$field_name."\").value=\"\"' title='".$this->lang['clear']."'>[".$this->lang['clear']."]</a>";                            
                        ...
                        case "validator":                           
                            ...
                            return $field_property_pre_addition.$this->nbsp."<input type='".$validator_field_type."' class='".$this->cssClass."_dg_textbox' ".$field_width." title='".$this->GetFieldTitle($field_name)."' name='".$field_req_type.$field_property_for_field."' id='".$field_req_type.$field_property_for_field."' value='' $field_maxlength $readonly ".$on_js_event.">".$this->nbsp.$field_property_post_addition;                                
                    ...
                    switch($field_type){
                        ...
                        case "image":
                            ...
                            $img_default                  = (($field_property_default != "") && file_exists($field_property_target_path.trim($field_property_default))) ? "<img src='".$field_property_target_path.$field_property_default."' width='".$field_property_image_width."' height='".$field_property_image_height."' alt='' title=''>" : "<span class='".$this->cssClass."_dg_label'>".$this->lang['no_image']."</span>";                    
                        ...
                        case "label":
                            ...
                            return $field_property_pre_addition.$this->nbsp."<label class='".$this->cssClass."_dg_label' ".$on_js_event.">".trim($field_value)."</label>".$this->nbsp.$field_property_post_addition;

                            break;

                        case "link":                        

                            $field_property_field_data = $this->GetFieldProperty($field_name, "field_data", "edit", "normal");
                            ...
                            if($field_property_field_data != ""){
                                ...
                                return $field_property_pre_addition.$this->nbsp."<a class='".$this->cssClass."_dg_a2' ".(($href != "") ? "href='".$href."'" : "style='cursor:pointer;'")." target='".$field_property_target."' ".$on_js_event.">".$link_value."</a>".$this->nbsp.$field_property_post_addition;

                            }else{

                                return $field_property_pre_addition.$this->nbsp.$field_value.$this->nbsp.$field_property_post_addition;
                        ...
                        case "money": 
                            ...
                            $field_property_decimal_places   = $this->GetFieldProperty($field_name, "decimal_places", "edit"); 

                            $field_property_dec_separator    = $this->GetFieldProperty($field_name, "dec_separator", "edit"); 

                            $field_property_thousands_separator = $this->GetFieldProperty($field_name, "thousands_separator", "edit");                        
                            ...
                            return $field_property_pre_addition.$this->nbsp.$money_sign_before."<label class='".$this->cssClass."_dg_label' ".$on_js_event.">".number_format($field_value, $field_property_decimal_places, $field_property_dec_separator, $field_property_thousands_separator)."</label>".$money_sign_after.$this->nbsp.$field_property_post_addition;

                            break;                     

                        case "password":

                            return $field_property_pre_addition.$this->nbsp."<label class='".$this->cssClass."_dg_label'>".(($field_property_hide == "true" || $field_property_hide == true) ? "******" : $field_value)."</label>".$this->nbsp.$field_property_post_addition;
    ...
    protected function DrawCheckBoxes($tag_name, $foo_name, &$select_array, $compare = "", $field_name="", $sub_field_value="", $sub_field_name="", $disabled="", $on_js_event="", $multiple=false, $multiple_size="4"){                       
        ...
        if($this->isPrinting != true){
            ...
            if(is_array($select_array)){
                ...
                if(!is_array($compare)){ $split_compare = split(",",$compare); }else{ $split_compare = $compare; }
    ...
    protected function DrawDropDownList($tag_name, $foo_name, &$select_array, $compare = "", $field_name="", $sub_field_value="", $sub_field_name="", $disabled="", $on_js_event="", $multiple=false, $multiple_size="4"){                       
        ...
        if($this->isPrinting != true){
            ...
            if(is_object($select_array)){
                ...
                if($this->dbHandler->isError($select_array) != 1){
                    ...
                    while($row = $select_array->fetchRow()){
                        ...
                        if(strtolower($row[$this->arrForeignKeys[$field_name][$sub_field_value]]) == strtolower($compare)) 
                            ...
                            $text .= "<option selected='selected' value='".$row[$this->arrForeignKeys[$field_name][$sub_field_value]]."'>".$row[$ff_name]."</option>";
                ...
                $text = "<select class='".$this->cssClass."_dg_select' name='".$tag_name."' id='".$tag_id."' ".(($foo_name != "") ? "onChange='".$this->uniquePrefix.$foo_name."'" : "")." ".$disabled." ".$on_js_event." ".$multiple_parameters.">";
                ...
                foreach($select_array as $key => $val){
                    ...
                    if(count($split_compare) > 1){
                        ...
                        foreach($split_compare as $spl_val){
                            ...
                            if($spl_val == $key) {$selected = "selected='selected'"; break; }	

                        }

                    }else{

                        $selected = ((strtolower($compare) == strtolower($key)) ? "selected='selected'" : "");
    ...
    protected function DrawControlButtons($row_id = ""){        
        ...
        if(isset($this->modes['details'][$this->mode]) && $this->modes['details'][$this->mode]){
            ...
            $this->DrawModeButton("details", "javascript:".$this->uniquePrefix."_doPostBack(\"details\", ".$row_id.");", $this->lang['details'], $this->lang['view_details'], "details.gif", "''", false, $this->nbsp, "");                        
        ...
        if($this->ajaxEnabled){
            ...
            echo $this->ScriptOpen();
                ...
                echo "function ".$this->uniquePrefix."_doAjaxRequest(query_string, http_url){
                    ...
                    dg_doAjaxRequest(query_string, '".$this->uniquePrefix."', http_url);
    ...
    protected function SetEditFieldsFormScript($url=""){
        ...
        echo "function ".$this->uniquePrefix."updateWysiwygFields(){ ";
            ...
            if($this->browserName == "Firefox"){
                ...
                echo " result_value = ".$this->uniquePrefix."updateWysiwygFieldsFF()";

            }else{ // "MSIE" or other

                echo " result_value = ".$this->uniquePrefix."updateWysiwygFieldsIE()";
        ...
        echo "function ".$this->uniquePrefix."updateWysiwygFieldsFF(){
        ...
        echo "function ".$this->uniquePrefix."updateWysiwygFieldsIE(){
            ...
            if($field_property_type == "password"){
                ...
                if($field_property_cryptography == true || $field_property_cryptography == "true"){
                    ...
                    if($field_property_cryptography_type == "aes"){
						...
						$fields_list .= "RSA_DECRYPT(".$column_name.", '".$field_property_aes_password."') as ".$column_name.", ";    
					}
    ...
    protected function DrawControlButtonsJS(){
        ...
        var paging_url  = '".$paging_curr_url."'+param;  paging_url  = paging_url.replace(/&amp;/g, '&');        
    ...
    protected function DrawCalendarButton($field_name, $field_type, $datetime_format="Y-m-d", $field_value="", $field_property_pre_addition="", $field_property_post_addition="", $field_width="", $field_maxlength="", $on_js_event="", $readonly=false, $field_property_calendar_type = "popup"){
        ...
        if($field_property_calendar_type == "floating"){
            ...
            $ret_date  = $this->nbsp."<input class='".$this->cssClass."_dg_textbox' ".$field_width." readonly type='text' title='".$this->GetFieldTitle($field_name)."' name='".$this->GetFieldRequiredType($field_name).$field_name."' id='".$this->GetFieldRequiredType($field_name).$field_name."' value='".$this->MyDate($field_value, $field_type)."' $field_maxlength ".$on_js_event.">";

            if(!$readonly) $ret_date .= "<img id='img".$this->GetFieldRequiredType($field_name).$field_name."' src='".$this->directory."styles/".$this->cssClass."/images/cal.gif' alt='".$this->lang['set_date']."' title='".$this->lang['set_date']."' align='top' style='cursor:pointer;margin:3px;margin-left:6px;margin-right:6px;border:0px;'></a>".$this->nbsp.$this->ScriptOpen()."Calendar.setup({inputField : '".$this->GetFieldRequiredType($field_name).$field_name."', ifFormat : '".$if_format."', showsTime : ".$show_time.", button : 'img".$this->GetFieldRequiredType($field_name).$field_name."'});".$this->ScriptClose();
            ...
            if(!$readonly) $ret_date .= "<a class='".$this->cssClass."_dg_a2' style='cursor: pointer;' onClick='setCalendarDate(\"".$this->uniquePrefix."frmEditRow\", \"".$field_id."\", \"".$datetime_format."\", \"".date($datetime_format)."\", \"".(date("Y")-50)."\")'>[".date($datetime_format)."]</a>";

            if((!$readonly) && (substr($this->GetFieldRequiredType($field_name), 0, 1) == "s")) $ret_date .= "&nbsp;<a class='".$this->cssClass."_dg_a2'  style='cursor: pointer;' onClick='resetDDL(\"".$field_id."__nc_year\");resetDDL(\"".$field_id."__nc_month\");resetDDL(\"".$field_id."__nc_day\");resetDDL(\"".$field_id."__nc_hour\");resetDDL(\"".$field_id."__nc_minute\");resetDDL(\"".$field_id."__nc_second\");' title='".$this->lang['clear']."'>[".$this->lang['clear']."]</a>";                                    
            ...
            if(!$readonly) $ret_date .= "<a class='".$this->cssClass."_dg_a2' title='".$this->GetFieldTitle($field_name)."' href=\"javascript:openCalendar('".(($this->ignoreBaseTag) ? $this->HTTP_HOST."/" : "").$this->directory."','', '".$this->uniquePrefix."frmEditRow', '".$this->GetFieldRequiredType($field_name)."', '".$field_name."', '$field_type')\"><img src='".$this->directory."styles/".$this->cssClass."/images/cal.gif' alt='".$this->lang['set_date']."' title='".$this->lang['set_date']."' align='top' style='MARGIN:3px;margin-left:6px;margin-right:6px;border:0px;'></a>".$this->nbsp;

        }

        if(($field_property_calendar_type == "floating") || ($field_property_calendar_type == "popup")){

            if(!$readonly) $ret_date .= "<a class='".$this->cssClass."_dg_a2' style='cursor: pointer;' onClick='document.getElementById(\"".$this->GetFieldRequiredType($field_name).$field_name."\").value=\"".date($datetime_format)."\"'>[".date($datetime_format)."]</a>";
        ...
        if(is_array($this->columnsEditMode)){        
            ...
            foreach($this->columnsEditMode as $fldName => $fldValue){
                ...
                foreach($fldValue as $key => $val){
                    ...
                    if(($key == "magnify_type") && ($val == "popup")) { $this->existingFields['magnify_field_edit_magnifier'] = true; }
