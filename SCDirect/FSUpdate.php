...
$iquery = "select cuserid from fratpos where cposition = \"Financial Secretary\" and cfratyear = \"$cfratyear\"";
echo $iquery;
...
while ($row = $res->fetch_array()){
	echo $row;
	$userid = $row['cuserid'];
 	$insquery = "INSERT INTO fratpos (cuserid, cposition, cfratyear, dirgroup, secorder) VALUES($userid, \"Financial Secretary\", $nfratyear, 7, 0) ";
	echo $insquery;
	echo "<br>";
...
echo "Financial Secretary Records Have been updated.";
