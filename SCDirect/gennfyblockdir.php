...
function GenCouncilBlock($infoarr,$carr, $sect){
			...
			if (strlen($meet1)>5){
				if (strlen($meet2)>5){
					...
					$block .= $coltab ."," .$coltab ."Additional Meeting:" .$coltab .trim($mtime2) .$coltab .trim($meet2) ;
					$block .= "<br>";
					$blines++;
				} else {
...
// 4th Degree State
$pdf->SetHeaderData("4thdegree.png", 20	, "Tennessee State Council Directory", "Contact stateadvocate@kofc-tn.org with Corrections");
