...
$locat2 = "http://$loc$installpath/managemenu.php";

$locat1 = "http://$loc$installpath/adminmenu.php";
...
<?php
      ...
      ## define the items common to all of the data grid displays
