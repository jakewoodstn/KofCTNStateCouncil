...
$pdf->writeHTMLCell(0,40,0,110,"Tennessee State Council Directory <br> Fraternal Year 2011-2012",0,0,0,true,"C",true);
...
$qry = "Select * from members order by CONCAT(clname,', ',cfname)";
...
if ($data){
	...
	if (mysql_num_rows($data)>0){
		...
		while ($info = mysql_fetch_array( $data )) {
			$qry2 = "select cuserid, cposition from fratpos where cuserid='" .$info['cuserid'] ."' and cuserid <> 'admin'" ;
			echo $qry2;
			$posstr = "";
...
$ttg = (time()-$starttime);
$ttgmsg = "Generated in " .$ttg ."seconds";

mail("tstaller@aol.com","PDF Generated",$ttgmsg);
